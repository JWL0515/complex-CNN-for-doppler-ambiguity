...
from torch.nn import Conv2d, Linear, BatchNorm1d, BatchNorm2d, Conv3d, BatchNorm3d, Conv1d, BatchNorm1d
...
class ComplexConv2d(Module):
    ...
    def forward(self, input):
        # print('Real Kernel:', self.conv_r.data)
        # print('Imaginere Kernel:', self.conv_i.data)
...
class ComplexAvgPool3d(Module):
    ...
    def forward(self, input):
        return complex_avg_pool3d(input, kernel_size=self.kernel_size,
                                  stride=self.stride, padding=self.padding,
                                  dilation=self.dilation, ceil_mode=self.ceil_mode,
                                  return_indices=self.return_indices)
