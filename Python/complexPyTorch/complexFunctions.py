...
from torch.nn.functional import relu, max_pool2d, avg_pool2d, dropout, dropout2d, interpolate, \
    sigmoid, tanh, dropout3d, avg_pool3d, max_pool3d, max_pool1d, leaky_relu, hardtanh
import torch
...
def complex_avg_pool3d(input, *args, **kwargs):
    '''
    Perform complex average pooling.
    '''
    absolute_value_real = avg_pool3d(input.real, *args, **kwargs)
    absolute_value_imag = avg_pool3d(input.imag, *args, **kwargs)
